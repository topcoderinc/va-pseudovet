...
def random_patient(index, war_era, end_year, work_entity):
    """
...
def generate_records(war_era, patients_num, male_perc, morbidities_data, end_year,
    ...
    patients = [random_patient(idx, war_era, end_year, work_entity) for idx in range(1, patients_num + 1)]
...
def generate_from_config(dataset_config, dataset_manager):
    ...
    generate_thread = threading.Thread(target=generate_records,
                                       args=(full_war_era, patients_num, male_ratio,
